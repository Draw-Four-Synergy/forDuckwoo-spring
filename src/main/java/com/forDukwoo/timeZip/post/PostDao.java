...
public class PostDao {
    ...
    public int insertPosts(PostPostReq postPostReq) {
        String insertPostsQuery = "insert into community (content, hashtag, user_id) values (?, ?, ?)";
        Object[] insertResultsParams = new Object[]{ postPostReq.getContent(), postPostReq.getHashtag(), postPostReq.getUserId()};
